############################################################################
###########  Aguascalientes Ingresos por fuente por decil #################
#########################################################################
...
write.dbf(c_DECIL_ES,file = "Aguascalientes Ingresos por fuente por DECIL estimaciones.dbf")
write.dbf(c_DECIL_SE,file = "Aguascalientes Ingresos por fuente por DECIL errores standard.dbf")
write.dbf(c_DECIL_CV,file = "Aguascalientes Ingresos por fuente por DECIL CV.dbf")
write.dbf(c_DECIL_LI,file = "Aguascalientes Ingresos por fuente por DECIL LI.dbf")
write.dbf(c_DECIL_ES,file = "Aguascalientes Ingresos por fuente por DECIL LS.dbf")