############################################################################
###########  Nacional Ingresos por fuente por decil INDIGENA #############
#########################################################################
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH 2018/ENIGH2018/Nacional/Indigena")

write.dbf(c_DECIL_ES,file = "Nacional Ingresos por fuente por DECIL INDIGENA estimaciones.dbf")
write.dbf(c_DECIL_SE,file = "Nacional Ingresos por fuente por DECIL INDIGENA errores standard.dbf")
write.dbf(c_DECIL_CV,file = "Nacional Ingresos por fuente por DECIL INDIGENA CV.dbf")
write.dbf(c_DECIL_LI,file = "Nacional Ingresos por fuente por DECIL INDIGENA LI.dbf")
write.dbf(c_DECIL_ES,file = "Nacional Ingresos por fuente por DECIL INDIGENA LS.dbf")
